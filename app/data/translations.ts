...
const VALS_ZH: Val[] = [
  { icon: Target,   t: '注重细节',    d: '微小的细节决定了优秀与卓越的区别。我总是比别人更早发现它们。' },
  { icon: Code2,    t: '坚持编写整洁代码', d: '六个月后无人能读懂的代码是技术债务。我是为了人类阅读而写代码。' },
  { icon: Zap,      t: '性能即是尊严', d: '速度代表着对用户的尊重。每一毫秒都至关重要。' },
  { icon: Users,    t: '真诚地协同合作', d: '在一次结对编程中我学到的知识，比我独自钻研一周学到的还要多。' },
  { icon: BookOpen, t: '保持终身学习', d: '技术每周都在迭代。我总是投入精力去理解它背后的底层逻辑。' },
  { icon: Heart,    t: '方法论解决复杂问题', d: '我用严谨的方法论面对复杂性。一个清晰定义的问题已经解决了一半。' },
];

const VALS_AR: Val[] = [
  { icon: Target,   t: 'الاهتمام بالتفاصيل', d: 'التفاصيل الصغيرة هي ما يفرق بين العمل الجيد والعمل الاستثنائي. ألاحظها قبل أن يطلبها أي شخص.' },
  { icon: Code2,    t: 'كتابة الكود النظيف دائماً', d: 'الكود الذي لا يستطيع أحد قراءته بعد ستة أشهر هو دين تقني. أنا أكتب من أجل البشر.' },
  { icon: Zap,      t: 'الأداء كقيمة جوهرية', d: 'السرعة تعني الاحترام. كل جزء من الثانية يمثل أهمية بالغة.' },
  { icon: Users,    t: 'التعاون الحقيقي والفعال', d: 'أتعلم في جلسة برمجة ثنائية واحدة أكثر مما أتعلمه في أسبوع كامل بمفردي.' },
  { icon: BookOpen, t: 'التعلم المستمر مدى الحياة', d: 'التكنولوجيا تتطور كل أسبوع. أستثمر وقتي في فهم أسباب وأهمية هذا التطور.' },
  { icon: Heart,    t: 'حل المشكلات المعقدة بمنهجية', d: 'أواجه التعقيد بالمنطق والمنهجية. المشكلة المحددة بوضوح هي مشكلة نصف محلولة بالفعل.' },
];
...
export const TX: Record<Lang, Tx> = {
  ...
  zh: mkTx(
    ['早上好', '下午好', '晚上好'], '我是', (t) => `${t}，我是`,
    '计算机工程师 · 全栈开发专家', '我近乎苛刻地雕琢那些无人注意但人人都能感受到的产品细节。', '有空档',
    '浏览作品', '取得联系', '查看简历', '向下滚动', ['首页', '技术栈', '项目作品', '关于我', '开发信条', '联系我'],
    '关于我', '深刻理解你的真实需求。', "我坚信最有价值的代码绝非炫技之作，而是能切实消除用户痛点的逻辑。坚固耐用的后端，灵动丝滑的前端，不拘泥于任何教条主义。",
    [['5+', '活跃项目'], ['100%', '品质执念'], ['∞', '坚韧架构']],
    '技术栈', '我所熟练掌握的技术领域。', ['后端开发', '前端开发', '系统与运维', '工具与数据', '人工智能与LLM代理'],
    '项目作品', '精选代表作。',
    '基于 Node.js, Express 和 MongoDB 构建的足球运动员竞猜游戏后端服务。',
    '基于 Java 构建的分布式拼车出行平台，采用三层架构与 JAX-WS 协议。',
    '基于 Node.js 的轻量级内存资源管理 REST API。',
    ['首席架构师', '后端 / API 专家', '系统工程师', '云架构工程师', '无障碍(A11y)专家'],
    'GitHub · 最新动态', '更多 GitHub 仓库', '加载中…', '联系我', '让我们开始对话。', '我目前正在寻找实习或初级工程师岗位。如果你正在创造真正有价值的产品，请随时与我联系。',
    '开发信条', '超越代码本身。', VALS_ZH, '搜索栏目…', '切换语言', '栏目导航', '期待再次相遇 | Eneko Ruiz', 'Eneko Ruiz | 全栈开发专家',
    '在 Donostia 精雕细琢设计并实现。基于 Next.js 16, Tailwind CSS 和 GSAP。', '查看源代码', 'eneekoruiz@gmail.com · github.com/eneekoruiz · linkedin.com/in/eneekoruiz',
    '返回', '直接打开'
  ),

  ar: mkTx(
    ['صباح الخير', 'مساء الخير', 'مساء الخير'], 'أنا', (t) => `${t}، أنا`,
    'مهندس كمبيوتر · مطور ويب متكامل', 'أهتم بأدق التفاصيل التي لا يلاحظها أحد ولكن الجميع يشعر بوجودها.', 'متاح للعمل',
    'عرض أعمالي', 'اتصل بي', 'عرض السيرة الذاتية', 'مرر للأسفل', ['الرئيسية', 'التقنيات', 'المشاريع', 'من أنا', 'المنهجية', 'الاتصال'],
    'من أنا', 'أفهم جيداً ما تحتاج إليه.', "لقد تعلمت أن الكود الأكثر قيمة ليس الأكثر تعقيداً، بل هو الكود الذي يحل بدقة مشكلة المستخدم الفعلي. خلفية برمجية متينة، وواجهة أمامية مريحة وتفاعلية، دون التمسك بقواعد جامدة.",
    [['5+', 'مشاريع نشطة'], ['100%', 'التركيز على الجودة'], ['∞', 'بنية برمجية صلبة']],
    'التقنيات', 'التقنيات التي أتقنها.', ['برمجة الخلفية', 'برمجة الواجهة', 'النظم والعمليات', 'البيانات والأدوات', 'الذكاء الاصطناعي ووكلاء LLM'],
    'المشاريع', 'أعمال مختارة.',
    ...
    ['كبير المعماريين', 'الخلفية البرمجية / API', 'مهندس نظم', 'مهندس سحابي', 'أخصائي إمكانية الوصول (A11y)'],
    'GitHub · النشاط الأخير', 'المزيد على GitHub', 'جاري التحميل…', 'الاتصال', 'دعنا نتحدث.', 'أبحث عن تدريب عملي أو منصب مهندس مبتدئ. إذا كنت تبني شيئاً يستحق العناء، فأنا هنا للمساعدة.',
    'المنهجية', 'ما وراء الكود.', VALS_AR, 'البحث عن الأقسام…', 'اللغة', 'التنقل', 'عد قريباً | Eneko Ruiz', 'Eneko Ruiz | مطور ويب متكامل',
    'تم التصميم والتطوير بشغف في دونستيا. باستخدام Next.js 16 و Tailwind CSS و GSAP.', 'عرض الكود المصدر', 'eneekoruiz@gmail.com · github.com/eneekoruiz · linkedin.com/in/eneekoruiz',
    'رجوع', 'فتح مباشر'
  ),
};
