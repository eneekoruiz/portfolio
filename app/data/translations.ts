...
export const TX: Record<Lang, Tx> = {
  ...
  eu: mkTx(
    ...
    'Lanak ikusi', 'Idatzi', 'Curriculuma ikusi', 'MUGITU', ['Hasiera', 'Stack', 'Proiektuak', 'Ni buruz', 'Kontaktua'],
    ...
    'Stack', 'Menperatzen ditudan teknologiak.', ['Backend', 'Frontend', 'DevOps eta Sistemak', 'Datuak eta Tresnak'],
  ...
  fr: mkTx(
    ...
    'Voir projets', 'Contact', 'Voir Curriculum', 'DÉFILER', ['Accueil', 'Stack', 'Projets', 'À propos', 'Contact'],
    ...
    'Stack', 'Technologies que je maîtrise.', ['Backend', 'Frontend', 'DevOps & Systèmes', 'Données & Outils'],
  ...
  it: mkTx(
    ...
    'Vedi progetti', 'Contatto', 'Vedi Curriculum', 'SCORRI', ['Inizio', 'Stack', 'Progetti', 'Chi sono', 'Contatto'],
    ...
    'Stack', 'Tecnologie che padroneggio.', ['Backend', 'Frontend', 'DevOps e Sistemi', 'Dati e Strumenti'],
  ...
  de: mkTx(
    ...
    'Stack', 'Technologien, die ich beherrsche.', ['Backend', 'Frontend', 'DevOps & Systeme', 'Daten & Tools'],
  ...
  pt: mkTx(
    ...
    'Ver projetos', 'Contacto', 'Ver Currículum', 'ROLAR', ['Início', 'Stack', 'Projetos', 'Sobre mim', 'Contato'],
    ...
    'Stack', 'Tecnologias que domino.', ['Backend', 'Frontend', 'DevOps e Sistemas', 'Dados e Ferramentas'],
  ...
  ca: mkTx(
    ...
    'Projectes', 'Contacte', 'Veure Currículum', 'DESPLAÇA', ['Inici', 'Stack', 'Projectes', 'Sobre mi', 'Contacte'],
  ...
  gl: mkTx(
    ...
    'Proxectos', 'Contacto', 'Ver Currículum', 'DESPRAZAR', ['Inicio', 'Stack', 'Proxectos', 'Sobre min', 'Contacto'],
    ...
    'Projetos', 'Traballos selecionados.',
  ...
  ja: mkTx(
    ...
    'コンピューター工学 · フルスタック開発者', '誰も気づかない。でも、誰もが感じる。そんな細部に全力を注ぎます。', '採用枠あり',
    ...
    'プロジェクト', '厳選した作品。',
    'サッカー選手当てゲーム babysitting バックエンド（Node.js、Express、MongoDB）。',
