...
export default function LabPage() {
  ...
  useEffect(() => {
    window.__galaxy?.setAttract(attract);
  }, [attract]);
  useEffect(() => {
    window.__galaxy?.setSpeed(speed);
  }, [speed]);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(100,160,255,.6) 1px,transparent 1px),linear-gradient(90deg,rgba(100,160,255,.6) 1px,transparent 1px)",
      ...
      <div className="absolute top-0 left-0 right-0 p-6 flex items-start justify-between z-10 pointer-events-none">
        <div className="bg-black/40 backdrop-blur-md rounded-2xl px-5 py-3 border border-white/[0.08]">
          <h1 className="font-mono font-bold text-white text-[15px] tracking-[.2em] mb-0.5">
            GALACTIC SPIRAL
          </h1>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex items-center gap-3">
        <div className="bg-black/40 backdrop-blur-md rounded-2xl p-3 border border-white/[0.08] flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <span className="font-mono text-[9px] text-white/40 w-6">
              {speed.toFixed(1)}×
            </span>
          </div>
        </div>
