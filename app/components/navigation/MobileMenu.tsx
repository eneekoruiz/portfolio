...
export function MobileMenu({ menu, setMenu, lang, setLang, t, menuRefs }: MobileMenuProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-page dark:bg-[#050505]" onClick={() => setMenu(false)} />
          ...
          <div className="flex gap-2 flex-wrap">
            {(Object.keys(LANG_LABELS) as Lang[]).map(l => (
              <button
                ...
                className={`font-mono text-[11px] font-bold tracking-widest border rounded-lg px-4 py-2 transition-all ${lang === l
